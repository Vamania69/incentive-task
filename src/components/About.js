...
const About = () => {
  return (
    <>
      <section className="about-section m-8">
        ...
        <div className="list-container mt-5 space-y-5">
          <div className=" flex justify-between  p-4 md:p-6 bg-[#1F1F1F]  rounded-lg">
            <h3 className="text-sm xs:text-xl sm:text-3xl">What is an ESOP?</h3>
            <button className="text-xl">+</button>
          </div>
          <div className=" p-4 md:p-6 bg-[#1F1F1F]  rounded-lg">
            <div className="flex justify-between ">
              <h3 className="text-sm xs:text-xl sm:text-3xl">How does the calculator determine ESOP outcomes??</h3>
              <button className="text-xl">-</button>
            </div>
          ...
          <div className=" flex justify-between p-4 md:p-6 bg-[#1F1F1F]  rounded-lg">
            <h3 className="text-sm xs:text-xl sm:text-3xl">What is the "Vesting Period" in an ESOP?</h3>
            <button className="text-base md:text-xl">+</button>
          </div>
          <div className=" flex justify-between p-4 md:p-6 bg-[#1F1F1F]  rounded-lg">
            <h3 className="text-sm xs:text-xl sm:text-3xl"> Can I use this calculator for any type of ESOP plan?</h3>
            <button className="text-base md:text-xl">+</button>
          </div>
        </div>
      </section>
